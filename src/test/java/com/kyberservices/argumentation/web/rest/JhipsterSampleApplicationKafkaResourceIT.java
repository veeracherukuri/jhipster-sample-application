...
import com.kyberservices.argumentation.config.KafkaProperties;
...
class JhipsterSampleApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleApplicationKafkaResource kafkaResource = new JhipsterSampleApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
