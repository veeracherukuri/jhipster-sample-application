...
@Configuration
@EnableMongoRepositories("com.kyberservices.argumentation.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.kyberservices.argumentation.config.dbmigrations");
